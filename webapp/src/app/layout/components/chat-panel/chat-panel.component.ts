...
export class ChatPanelComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    /**
     * Decide whether to show or not the sentimentReview's avatar in the message row
     *
     * @param message
     * @param i
     * @returns {boolean}
    ...
    /**
     * Toggle chat with the sentimentReview
     *
     * @param contact
     */
    toggleChat(contact): void
    {
        // If the sentimentReview equals to the selectedContact,
        // that means we will deselect the sentimentReview and
        // unload the chat
        ...
        // Otherwise, we will select the sentimentReview, open
        ...
        else
        {
            ...
            // Set the selected sentimentReview
    ...
    /**
     * Remove the selected sentimentReview and unload the chat
     */
    resetChat(): void
    {
        // Set the selected sentimentReview as null
        this.selectedContact = null;
