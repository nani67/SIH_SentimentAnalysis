...
export class ContactsSelectedBarComponent implements OnInit, OnDestroy
{
        ...
        this._contactsService.onSelectedContactsChanged
            ...
            .subscribe(selectedContacts => {
                ...
                setTimeout(() => {
                    ...
                    this.isIndeterminate = (selectedContacts.length !== this._contactsService.sentimentReviews.length && selectedContacts.length > 0);
                }, 0);
            });
    }
    ...
    deleteSelectedContacts(): void
    {
        ...
        this.confirmDialogRef.componentInstance.confirmMessage = 'Are you sure you want to delete all selected sentimentReviews?';
